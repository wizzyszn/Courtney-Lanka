...
export default function Header() {
  return (
    <div className=' p-48 pt-6 h-svh mt-2 max-[720px]:p-0 max-[720px]:mt-0 max-[720px]:h-[35rem]'>
        ...
        <Reveal className='z-0 absolute right-8 max-[720px]:static'>
            <img src={header_img} alt="header" />
          </Reveal> 
      <Reveal className=' flex flex-col gap-4 h-[35rem] w-[40%] max-[720px]:w-full max-[720px]:rounded-none max-[720px]:p-3 z-20 justify-center rounded-tr-[5rem] absolute bg-white top-20 max-[720px]:static max-[720px]:justify-start'>
