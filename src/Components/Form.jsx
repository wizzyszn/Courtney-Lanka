  ...
  return (
    <>
      <div className=' p-48 pt-9  h-[74rem]'>
        ...
        <div className=' flex flex-col gap-12 h-[45rem] w-[40%] z-20  rounded-tl-[5rem] absolute bg-white  top-20 right-0 p-12 '>
            <h1 className=' text-4xl font-semibold'>Connect With Your Next Great Hire Today!</h1>
