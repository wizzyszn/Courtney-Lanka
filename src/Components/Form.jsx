  ...
  return (
    <>
      <div className=' p-48 pt-9  h-[74rem]  max-[720px]:p-4  max-[720px]:h-[85rem]'>
        ...
        <Reveal className=' flex flex-col gap-12 h-[45rem]  w-[40%] z-20  rounded-tl-[5rem] absolute bg-white  top-20 right-0 p-12  max-[720px]:top-60  max-[720px]:left-0  max-[720px]:w-[90%]  max-[720px]:m-auto  max-[720px]:rounded-none '>
            ...
            <div className=' w-full p-3 bg-gradient-to-tr from-[#FF9900] to-[#F2CB00] rounded-lg flex items-center justify-center gap-1 cursor-pointer text-white shadow-md'><span>GET CONSULTATION</span><GoArrowRight /></div>
        </Reveal>
        <Reveal className=' z-0 absolute left-0  max-[720px]:top-0'>
